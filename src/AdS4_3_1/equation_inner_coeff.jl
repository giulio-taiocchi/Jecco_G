...
BB[1,1] = -x3 * x9*u
BB[1,2] = 0
CC[1,1] = -x10 * x3 * (x15 * x7 * (-Gp + x12) + x17)*u
CC[1,2] = x15 * x18 * x3*u
SS[1] = u*(x0 * x19 * x52 * x7 * (-Fxh * Gp + Fxp * Gh - Fyp * Gt + Fyt * Gp - Gh * x38 + Gt * x21 + x33 * (-Fx * Gp + 3 * Fxp * G) + x46 * x47 - x47 * x48 - x49 * x50 + x50 * x51 + xi_x * (-Fyp * x12 + Gp * x21)) - x19 * x22 * x29 * x30 + x19 * x32 * x35 + x19 * x36 * (x30 * x42 - 2 * x45)) - x31 * (12 * B * u - 4 * Bp)
AA[2,1] = 0
AA[2,2] = 0
BB[2,1] = 0
BB[2,2] = -x52 * x9
...
CC[2,2] = -x10 * x17 * x52
SS[2] = u*(-x13 * x52 * x55 * (Fx * Sh * x13 - Fxp * x23 + 4 * Fy * S * x57 + Fy * St * x13 - Fy * x43 - Fyp * x40 + x22 * x41 + x26 * x39 - x27 * x49 - x27 * x51 + x49 + x51) + x2 * x32 * x55 * (-Bh * Fxp * x0 + Bh * x57 - Bt * Fy * x56 + Bt * Fyp * x0 + 5 * Fx * Fy * x0 + Fxh * x58 - Fxh * x60 + Fxp * Fyp * u - Fxph - Fypt - Fyt * x58 + Fyt * x60 - x24 * x49 - x24 * x51 + x33 * (Bp * Fx * x0 - Fxp * x62 - Fxp + x43) - x44 * (-Fyp * x62 + Fyp + x21 * (Bp * x13 - 2)) + x46 + x48 + x49 * x61 - x51 * x61) + x22 * x29 * x53 * x54 - x35 * x53 * x7 + x36 * x53 * (x42 * x54 - x45)) + x31 * (-6 * G * u + 2 * Gp)
